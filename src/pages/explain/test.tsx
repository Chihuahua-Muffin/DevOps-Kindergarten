...
const TestPage = () => (
  <>
    ...
    <ExplainContent>
      빌드한 기능이 문제가 없는지 테스트를 합니다. 
      요구사항에 따라 계획한 기능을 충실하게 수행하는지 검증하는 테스트를 수행합니다.
    </ExplainContent>
    ...
    <ExplainTool
      ...
      explaination={(
        <>
          셀레늄(Selenium)은 웹 애플리케이션 테스트를 위한 포터블 프레임워크입니다. 
          셀레늄은 테스트 스크립트 언어를 학습할 필요 없이 기능 테스트를 만들기 위한 플레이백 도구를 제공합니다. 
          C#, Groovy, 자바, PHP, 파이썬, 루비, 스칼라 등 수많은 유명 프로그래밍 언어들에서 테스트를 작성하기 위한 테스트 도메인 특화 언어(Selenese)를 제공합니다.
        </>
      )}
